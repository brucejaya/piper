...
- Push wake payload parsing and agent reconnect routing for notification taps.
...
3. Choose and prove the iOS transport adapter.
4. Connect `PiperBridge` to the real Piper protocol client.
